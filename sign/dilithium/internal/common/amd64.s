...
TEXT ·makeHintAVX2(SB), NOSPLIT, $0-28
	...
	VPCMPEQD     Y1, Y13, Y14
	VPCMPEQD     (DX), Y2, Y4
	VPCMPEQD     32(DX), Y2, Y7
	VPCMPEQD     64(DX), Y2, Y10
	VPCMPEQD     96(DX), Y2, Y13
	VPAND        Y4, Y5, Y5
	VPAND        Y7, Y8, Y8
	VPAND        Y10, Y11, Y11
	VPAND        Y13, Y14, Y14
	...
	VPCMPEQD     Y1, Y10, Y11
	VPCMPEQD     Y1, Y13, Y14
	VPCMPEQD     128(DX), Y2, Y4
	VPCMPEQD     160(DX), Y2, Y7
	VPCMPEQD     192(DX), Y2, Y10
	VPCMPEQD     224(DX), Y2, Y13
	VPAND        Y4, Y5, Y5
	VPAND        Y7, Y8, Y8
	VPAND        Y10, Y11, Y11
	VPAND        Y13, Y14, Y14
	...
	VPCMPEQD     Y1, Y10, Y11
	VPCMPEQD     Y1, Y13, Y14
	VPCMPEQD     256(DX), Y2, Y4
	VPCMPEQD     288(DX), Y2, Y7
	VPCMPEQD     320(DX), Y2, Y10
	VPCMPEQD     352(DX), Y2, Y13
	VPAND        Y4, Y5, Y5
	VPAND        Y7, Y8, Y8
	VPAND        Y10, Y11, Y11
	VPAND        Y13, Y14, Y14
	...
	VPCMPEQD     Y1, Y10, Y11
	VPCMPEQD     Y1, Y13, Y14
	VPCMPEQD     384(DX), Y2, Y4
	VPCMPEQD     416(DX), Y2, Y7
	VPCMPEQD     448(DX), Y2, Y10
	VPCMPEQD     480(DX), Y2, Y13
	VPAND        Y4, Y5, Y5
	VPAND        Y7, Y8, Y8
	VPAND        Y10, Y11, Y11
	VPAND        Y13, Y14, Y14
	...
	VPCMPEQD     Y1, Y10, Y11
	VPCMPEQD     Y1, Y13, Y14
	VPCMPEQD     512(DX), Y2, Y4
	VPCMPEQD     544(DX), Y2, Y7
	VPCMPEQD     576(DX), Y2, Y10
	VPCMPEQD     608(DX), Y2, Y13
	VPAND        Y4, Y5, Y5
	VPAND        Y7, Y8, Y8
	VPAND        Y10, Y11, Y11
	VPAND        Y13, Y14, Y14
	...
	VPCMPEQD     Y1, Y10, Y11
	VPCMPEQD     Y1, Y13, Y14
	VPCMPEQD     640(DX), Y2, Y4
	VPCMPEQD     672(DX), Y2, Y7
	VPCMPEQD     704(DX), Y2, Y10
	VPCMPEQD     736(DX), Y2, Y13
	VPAND        Y4, Y5, Y5
	VPAND        Y7, Y8, Y8
	VPAND        Y10, Y11, Y11
	VPAND        Y13, Y14, Y14
	...
	VPCMPEQD     Y1, Y10, Y11
	VPCMPEQD     Y1, Y13, Y14
	VPCMPEQD     768(DX), Y2, Y4
	VPCMPEQD     800(DX), Y2, Y7
	VPCMPEQD     832(DX), Y2, Y10
	VPCMPEQD     864(DX), Y2, Y13
	VPAND        Y4, Y5, Y5
	VPAND        Y7, Y8, Y8
	VPAND        Y10, Y11, Y11
	VPAND        Y13, Y14, Y14
	...
	VPCMPEQD     Y1, Y10, Y11
	VPCMPEQD     Y1, Y13, Y14
	VPCMPEQD     896(DX), Y2, Y4
	VPCMPEQD     928(DX), Y2, Y7
	VPCMPEQD     960(DX), Y2, Y10
	VPCMPEQD     992(DX), Y2, Y13
	VPAND        Y4, Y5, Y5
	VPAND        Y7, Y8, Y8
	VPAND        Y10, Y11, Y11
	VPAND        Y13, Y14, Y14
