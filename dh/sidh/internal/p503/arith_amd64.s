...
TEXT ·adlP503(SB), NOSPLIT, $0-24
	...
	MOVQ	   (REG_P1),   R8;	ADDQ     (REG_P2),  R8;	MOVQ R8,      (REG_P3)
	...
	MOVQ	(56)(REG_P1),  R8;	ADCQ (56)(REG_P2),  R8;	MOVQ  R8, (56)(REG_P3)
	MOVQ	(64)(REG_P1),  AX;	ADCQ (64)(REG_P2),  AX;	MOVQ  AX, (64)(REG_P3)
	MOVQ	(72)(REG_P1),  BX;	ADCQ (72)(REG_P2),  BX;	MOVQ  BX, (72)(REG_P3)
	MOVQ	(80)(REG_P1),  CX;	ADCQ (80)(REG_P2),  CX;	MOVQ  CX, (80)(REG_P3)
