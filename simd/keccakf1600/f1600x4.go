// Package keccakf1600 provides a fourway Keccak-f[1600] permutation in parallel.
//
...
// uses AVX2 instructions available in some AMD64 architectures.
//
...
// The recommentation is to beforehand verify IsSIMDEnabled() to determine if
...
// StateX4 contains state for the fourway permutation including the four
...
// IsSIMDEnabled returns true if the architecture supports SIMD implementation
// provided in this package.
func IsSIMDEnabled() bool { return cpu.X86.HasAVX2 }
