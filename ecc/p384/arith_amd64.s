...
#define fp384Reduce(stack) \
	...
	ADCQ $0, 0+stack \
	\
	fp384Carry(R14,SI,AX,BX,CX,DX, 0+stack, R8,R9,R10,R11,R12,R13,DI)
...
TEXT ·fp384Neg(SB), NOSPLIT, $8-16
	...
	MOVQ $0, 0(SP)
	fp384Carry(R8,R9,R10,R11,R12,R13,0(SP), R14,AX,BX,CX,DX,DI,SI)

	MOVQ c+0(FP), DI
	storeBlock(R8,R9,R10,R11,R12,R13, 0(DI))
	RET

TEXT ·fp384Add(SB), NOSPLIT, $8-24
	MOVQ a+8(FP), DI
	MOVQ b+16(FP), SI
